      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#home" onClick={(e) => scrollTo(e, 'home')} className="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-green-600 transition-colors">Beranda</a>
            <a href="#teknologi" onClick={(e) => scrollTo(e, 'teknologi')} className="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-green-600 transition-colors">Teknologi</a>
            <a href="#simulasi" onClick={(e) => scrollTo(e, 'simulasi')} className="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-green-600 transition-colors">Simulasi</a>
            <a href="#testimoni" onClick={(e) => scrollTo(e, 'testimoni')} className="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-green-600 transition-colors">Testimoni</a>
