  ...
  return (
    <nav
      className={`fixed w-full z-50 transition-all duration-300 ${
        scrolled
          ? darkMode
            ? 'bg-zinc-900/95 backdrop-blur-md shadow-sm border-b border-zinc-800'
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              className="px-6 py-2.5 rounded-full text-sm font-bold bg-zinc-900 dark:bg-green-600 hover:bg-green-600 dark:hover:bg-green-700 text-white transition-all hover:shadow-lg active:scale-95 cursor-pointer"
            >
              Konsultasi
            </a>
          </div>
